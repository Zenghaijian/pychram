...
# 七里香
seven = "H /E E /\
        (CNY) (CN) /(AD)YY(ADY) /  (CNE)E/(AD) (CNR)R /\
        (CN) (CNE)E /(AD)WW(ADW) /  (CNH) /(ADE) (CNE) /\
        (CNY) (CN) /(AD)YY(ADY) /  (CNE)E/(AD) (CNR)R/\
        (CN) (CNE)E /(AD) H(AD) /E (CNE)E /(ADE) (CNE)/\
        (XNY) (XN) /(AD)YY(ADY) /  (XNE)E /(AD) (XNR)R /\
        (XN) (XNE)E /(AD)WW(ADW) /  (XNH) /(ADE) (XNE) /\
        (CNY) (CN) /(AD)YY(ADY) /  (CNE)E /(AD) (CNR)R /\
        (CN) (CNE)E /(AD)WW(ADW) / Q(CNQ)Q /(AD)  /\
        "
